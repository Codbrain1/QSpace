...
class SchemeFactory {
  public:
    static ReadScheme createSheme_v2_3(Visualize::EntityType type, FileFormat format) {
    ...
    static ReadScheme createSheme_v2(Visualize::EntityType type, FileFormat format) {
        if (format == FileFormat::BIN || format == FileFormat::TXT) {
            ColumnScheme scheme;
            if (type == QSpace::Visualize::EntityType::DarkMatter ||
                type == QSpace::Visualize::EntityType::Stars) {
