...
#include <cmath>
Converter_MolecularClouds::Converter_MolecularClouds(DataStorage& _data, ParametrsList::iniConstants& c, count_cell _Nbxy,
...
void Converter_MolecularClouds::calculate_LgSigma(std::vector<double>& projection1, std::vector<double>& projection2)
{
...
void Converter_MolecularClouds::calculate_Sigma(std::vector<double>& projection1, std::vector<double>& projection2)
{
    const auto& Ns = data.get_Ns();  // число строк в каждом файле
    const auto& m_p = data.get_m();
    const auto& offests = data.get_offsets();
...
void Converter_MolecularClouds::calculate_LgRho(std::vector<double>& projection1, std::vector<double>& projection2,
...
void Converter_MolecularClouds::calculate_Rho(std::vector<double>& projection1, std::vector<double>& projection2,
                                              std::vector<double>& projection3)
{
    const auto& Ns = data.get_Ns();  // число строк в каждом файле
    const auto& rho_p = data.get_rho();
...
void Converter_MolecularClouds::calculate_Vr(std::vector<double>& projection1, std::vector<double>& projection2,
...
void Converter_MolecularClouds::calculate_Vfi(std::vector<double>& projection1, std::vector<double>& projection2,
                                              std::vector<double>& projection3, std::vector<double>& v_projection1,
                                              std::vector<double>& v_projection2)
{
...
void Converter_MolecularClouds::calculate_V_projection(std::vector<double>& projection1, std::vector<double>& projection2,
...
void Converter_MolecularClouds::calculate_T(std::vector<double>& projection1, std::vector<double>& projection2,
                                            std::vector<double>& projection3)
{
    const auto& Ns = data.get_Ns();  // число строк в каждом файле
    const auto& offests = data.get_offsets();
...
void Converter_MolecularClouds::calculate_LgT(std::vector<double>& projection1, std::vector<double>& projection2,
                                              std::vector<double>& projection3)
{
    const auto& Ns = data.get_Ns();  // число строк в каждом файле
    const auto& offests = data.get_offsets();
