...
void Converter_DarkMatter::calculate_LgSigma(std::vector<double>& projection1, std::vector<double>& projection2)
{
...
void Converter_DarkMatter::calculate_LgRho(std::vector<double>& projection1, std::vector<double>& projection2,
...
void Converter_DarkMatter::calculate_Rho(std::vector<double>& projection1, std::vector<double>& projection2,
                                         std::vector<double>& projection3)
{
    const auto& Ns = data.get_Ns();  // число строк в каждом файле
    const auto& m_p = data.get_m();
...
void Converter_DarkMatter::calculate_Vr(std::vector<double>& projection1, std::vector<double>& projection2,
...
void Converter_DarkMatter::calculate_Vfi(std::vector<double>& projection1, std::vector<double>& projection2,
                                         std::vector<double>& projection3, std::vector<double>& v_projection1,
                                         std::vector<double>& v_projection2)
{
...
void Converter_DarkMatter::calculate_V_projection(std::vector<double>& projection1, std::vector<double>& projection2,
