...
class Converter_Gas : public IConverter_Hydrodinamics
{
   protected:
   ...
   public:
    Converter_Gas(DataStorage& _data, ParametrsList::iniConstants& c, count_cell _Nbxy, std::filesystem::path _output_path)
